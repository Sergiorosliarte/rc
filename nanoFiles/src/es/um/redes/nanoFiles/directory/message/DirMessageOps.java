...
public class DirMessageOps {
	...
	public static final byte OPCODE_SERVE_FILES_ALREADY = 11;
	public static final byte OPCODE_SERVE_FILES_FAIL = 12;
	public static final byte OPCODE_GETUSERS = 13;
	public static final byte OPCODE_USERLIST = 14;
	public static final byte OPCODE_STOPPED_SERVING = 15;
	public static final byte OPCODE_STOPPED_SERVING_OK = 16;
	public static final byte OPCODE_LOGOUT = 17;
	public static final byte OPCODE_LOGOUT_OK = 18;
